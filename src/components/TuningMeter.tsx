  ...
  return (
    <section className="rounded-3xl border border-slate-700/70 bg-slate-900/70 p-6 shadow-xl shadow-slate-950/20">
      ...
      <div className="relative h-20 rounded-full bg-slate-950/80 px-4">
        ...
        <div
          className="absolute left-1/2 top-1/2 h-16 w-2 origin-bottom -translate-x-1/2 -translate-y-1/2 rounded-full bg-white shadow-lg shadow-cyan-300/40 transition-transform duration-150 ease-out"
          style={{ transform: `translate(${offsetPercent}%, -50%)` }}
